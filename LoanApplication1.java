...
public class LoanApplication1 extends JDialog implements ActionListener
{
	...
	JLabel customer=new JLabel("Customer Id");JLabel lbl10=new JLabel("As per your PassBook");
	...
	LoanApplication1()
	{
		...
		lbl10.setForeground(Color.RED);lbl10.setVisible(true);
	...
	public void actionPerformed(ActionEvent evt)
	{
		...
		else if(evt.getSource()==submit)
		{
			...
			if(!PatternMatching44.nameCheck(full_name_txt.getText()))
			{
			...
			if(!PatternMatching44.nameCheck(spouse_name_txt.getText()))
			{
			...
			if(!PatternMatching44.nameCheck(father_name_txt.getText()))
			{
			...
			if(!PatternMatching44.nameCheck(mother_name_txt.getText()))
			{
			...
			if(!PatternMatching44.nameCheck(nationality_txt.getText()))
			{
			...
			if(!PatternMatching44.nameCheck(place_of_birth_txt.getText()))
			{
			...
			if(!PatternMatching44.nameCheck(permanent_add_txt.getText()))
			{
			...
			if(!PatternMatching44.nameCheck(local_add_txt.getText()))
			{
			...
			if(!PatternMatching44.mobCheck(phone_txt.getText()))
			{
			...
			if(!PatternMatching44.idCheck(customer_txt.getText()))
			{
